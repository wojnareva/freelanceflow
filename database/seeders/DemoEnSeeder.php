...
class DemoEnSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info('FreelanceFlow English demo data created successfully! 🎉');
        $this->command->info('Login with: demo@freelanceflow.app (password: password)');
